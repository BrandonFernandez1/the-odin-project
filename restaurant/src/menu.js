...
import tehAisMenu from './images/menu/teh-ais.jpg';
...
const menu = (function() {
    ...
    const getMenuItems = () => {
        ...
        //Beverages
        const tehAis = createMenuItem('Teh Ais', 2.5, 'Tea sweetened with condensed milk that is simply served in a glass with ice cubes', 'Beverages', tehAisMenu);
        menuItems.push(tehAis);
